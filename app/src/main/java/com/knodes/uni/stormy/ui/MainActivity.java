...
import com.knodes.uni.stormy.model.Current;
import com.knodes.uni.stormy.model.Day;
import com.knodes.uni.stormy.model.Forecast;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getForecast(latitude, longitude);
        Log.d(TAG, "MainAcitivity is running");

    }

    private void getForecast(double latitude, double longitude) {
        String apiKey="f79b522f73935388f2148376d7658784";
    ...
    private void updateDisplay() {
        ...
        mPrecipValue.setText(current.getPrecidChance() + "%");
        mSummaryLabel.setText(current.getSummary());

        Drawable drawable = getResources().getDrawable((int) current.getIconId(), null);
    ...
    private Current getCurrentDetails(String jsonData) throws JSONException{
        ...
        current.setPrecidChance(currently.getDouble("precipProbability"));
        current.setSummary(currently.getString("summary"));
        current.setTemperature(currently.getDouble("temperature"));
        current.setTimeZone(timezone);

        Log.d(TAG, "Datetime formatted:   "+ current.getFormattedTime());
        return current;
    }
